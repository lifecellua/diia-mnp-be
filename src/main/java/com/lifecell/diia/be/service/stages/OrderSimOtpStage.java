...
@Slf4j
@Service
public class OrderSimOtpStage implements StageHandler {
    ...
    public Stage getStage() {
        return Stage.STAGE_ORDER_SIM_OTP;
    }
