...
@Service
public class ErrorNoIdDocumentStage implements StageHandler {
    private static final String TARGET_NAME = "error_no_id_document";
    private static final String TEMPLATE_NAME = "no_passport";

    private final TemplateService templateService;

    public ErrorNoIdDocumentStage(
    ...
    public Stage getStage() {
        return Stage.STAGE_ERROR_NO_ID_DOCUMENT;
    }
